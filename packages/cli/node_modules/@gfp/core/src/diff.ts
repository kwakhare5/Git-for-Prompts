...
function diffField(field: string, before: unknown, after: unknown): FieldDiff {
 ...
 */
export function diffBundles(a: PromptBundle, b: PromptBundle): BundleDiff {
...
export function diffVersions(
  a: { content: string; bundle: PromptBundle | null },
  b: { content: string; bundle: PromptBundle | null }
): BundleDiff {
