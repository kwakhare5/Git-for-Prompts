            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[#161616] p-5 flex flex-col gap-3 shadow-xl">
              <div className="flex items-center justify-between">
                <h2 className="text-xs font-bold text-[#f5f0eb] uppercase tracking-wider font-mono flex items-center gap-2">
                  <Radio className="w-4 h-4 text-zinc-400" /> Webhook Payload
                </h2>
...

{
  ...
  "versionNumber": 3
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[#161616] p-5 flex flex-col gap-2 shadow-sm">
              <h2 className="text-xs font-bold text-[#f5f0eb] uppercase tracking-wider font-mono">Workflow Steps</h2>
              <ul className="flex flex-col gap-2 text-xs text-zinc-400 font-sans mt-1">
                <li className="flex items-start gap-2">
                  <span className="text-zinc-400 font-bold font-mono">1</span>
                  Register your HTTP/HTTPS endpoint below
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-zinc-400 font-bold font-mono">2</span>
                  Save your signing secret — shown once only
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-zinc-400 font-bold font-mono">3</span>
