...
function InteractiveTerminal() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto font-mono text-xs">
      <div className="rounded-xl border border-white/10 bg-[#161616] shadow-2xl overflow-hidden text-left">
        {/* Title Bar */}
        ...
        {/* Content body */}
        <div className="p-5 min-h-[150px] flex flex-col justify-between gap-4">
  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="text-4xl md:text-6xl font-extrabold tracking-tight text-white max-w-4xl leading-[1.15] text-balance z-10"
      >
        {siteConfig.headline}
      </motion.h1>
      ...
      <motion.p
        ...
        className="text-base md:text-lg text-zinc-400 max-w-xl leading-relaxed font-light z-10"
      >
        {siteConfig.tagline}
      </motion.p>
