    ...
    <>
      ...
      <section id="features" className="px-6 max-w-6xl mx-auto mb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-sans">
          ...
          <div className="bg-bg-card p-8 rounded-2xl border border-zinc-800/90 shadow-xl card-interactive hover:border-zinc-700">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 flex items-center justify-center font-mono font-bold mb-4 text-base">
              01
            </div>
            <h3 className="text-xl font-bold text-zinc-100 mb-2 font-mono">Immutable Append-Only Snapshots</h3>
            <p className="text-zinc-400 text-sm leading-relaxed font-sans">
              Every save creates a new Version row guarded by <code className="text-emerald-300 bg-bg-page px-1.5 py-0.5 rounded border border-zinc-800 font-mono text-xs">insertNextVersion</code> transaction locks. Never overwrite history.
            </p>
          </div>

          <div className="bg-bg-card p-8 rounded-2xl border border-zinc-800/90 shadow-xl card-interactive hover:border-zinc-700">
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-blue-300 border border-blue-500/20 flex items-center justify-center font-mono font-bold mb-4 text-base">
              02
            </div>
            <h3 className="text-xl font-bold text-zinc-100 mb-2 font-mono">Local-First Wasm Engine</h3>
            <p className="text-zinc-400 text-sm leading-relaxed font-sans">
              <code className="text-blue-300 bg-bg-page px-1.5 py-0.5 rounded border border-zinc-800 font-mono text-xs">packages/cli</code> runs completely offline with Wasm SQLite (<code className="text-blue-300 font-mono">sql.js</code>). Zero native dependencies.
            </p>
          </div>

          <div className="bg-bg-card p-8 rounded-2xl border border-zinc-800/90 shadow-xl card-interactive hover:border-zinc-700">
            <div className="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-300 border border-amber-500/20 flex items-center justify-center font-mono font-bold mb-4 text-base">
              03
            </div>
            <h3 className="text-xl font-bold text-zinc-100 mb-2 font-mono">Atomic Prompt Bundle Spec</h3>
            <p className="text-zinc-400 text-sm leading-relaxed font-sans">
              Store system prompt, template, parameters (model, temp, topP), tools, and <code className="text-amber-300 bg-bg-page px-1.5 py-0.5 rounded border border-zinc-800 font-mono text-xs">Zod</code> output schemas together.
            </p>
          </div>

          <div className="bg-bg-card p-8 rounded-2xl border border-zinc-800/90 shadow-xl card-interactive hover:border-zinc-700">
            <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-300 border border-purple-500/20 flex items-center justify-center font-mono font-bold mb-4 text-base">
              04
            </div>
            <h3 className="text-xl font-bold text-zinc-100 mb-2 font-mono">Secure Cloud Sync</h3>
            <p className="text-zinc-400 text-sm leading-relaxed font-sans">
              Authenticate via SHA-256 hashed API keys (<code className="text-purple-300 bg-bg-page px-1.5 py-0.5 rounded border border-zinc-800 font-mono text-xs">gfp_live_*</code>). Webhooks notify team on every save.
            </p>
          </div>
      ...
      <section id="cli" className="px-6 max-w-5xl mx-auto mb-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <a href="https://github.com/kwakhare5/Git-for-Prompts#readme" target="_blank" rel="noopener noreferrer" className="inline-block bg-zinc-100 hover:bg-white text-zinc-950 text-xs font-mono font-bold px-5 py-2.5 rounded-xl shadow-xs btn-interactive">
              Explore CLI Docs →
            </a>
          </div>

          <div className="lg:col-span-6 bg-bg-card rounded-2xl border border-zinc-800/90 p-6 shadow-2xl font-mono text-xs text-zinc-300">
            ...
            <div className="space-y-1 bg-bg-panel p-3 rounded border border-zinc-800 text-[11px] leading-relaxed">
