...
import {
  PromptRepositoriesList,
  PromptWithStats,
} from '@/components/domain/dashboard/prompt-repositories-list';
...
interface DashboardHeroReplicaProps {
  isDemo?: boolean;
  prompts?: PromptSummary[];
  isFullScreen?: boolean;
}

const DEMO_PROMPTS: PromptWithStats[] = [
  {
    id: 'demo-1',
...
export function DashboardHeroReplica({
  isDemo = true,
  prompts = [],
  isFullScreen = false,
}: DashboardHeroReplicaProps) {
