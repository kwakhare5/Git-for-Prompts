      ...
      <div className="bg-[#161619] rounded-3xl border border-zinc-800/80 p-8 md:p-12 shadow-xl text-zinc-100">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-zinc-100 font-serif mb-4 leading-tight">
            ...
            <button className="bg-zinc-100 hover:bg-white text-zinc-950 text-xs font-bold font-mono px-5 py-2.5 rounded-xl shadow-xs active:scale-97 transition-all cursor-pointer">
              Run Local Evals →
            </button>
          </div>
          ...
          <div className="lg:col-span-7 bg-[#1D1D22] p-4 rounded-2xl border border-zinc-800 shadow-inner">
            <div className="bg-[#121214] rounded-xl border border-zinc-800 overflow-hidden text-xs font-mono">
              ...
              <div className="px-4 py-3 border-b border-zinc-800 flex items-center justify-between font-bold text-zinc-200">
                ...
                <span className="text-emerald-300 text-[10px] bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">
                  88/88 PASSED
                </span>
              </div>
