  ...
  return (
    <>
      ...
      <section className="px-6 max-w-5xl mx-auto mb-28 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-zinc-100 mb-6 font-serif leading-tight">
      ...
      <section className="border-y border-zinc-800/80 bg-bg-card py-14 px-6 mb-28">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            <div className="text-4xl md:text-5xl font-black tracking-tight text-emerald-300 font-mono mb-1">0</div>
            <div className="text-xs font-medium text-zinc-400 font-sans">Cloud Lock-in</div>
          </div>
          <div>
            <div className="text-4xl md:text-5xl font-black tracking-tight text-amber-300 font-mono mb-1">&lt;10ms</div>
            <div className="text-xs font-medium text-zinc-400 font-sans">Local Eval Speed</div>
          </div>
          <div>
            <div className="text-4xl md:text-5xl font-black tracking-tight text-rose-300 font-mono mb-1">MIT</div>
