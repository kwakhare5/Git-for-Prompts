...
## Corpus Check
- 169 files · ~74,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 700 nodes · 1379 edges · 58 communities (43 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5612fdb`
...
Cohesion: 0.08
Nodes (27): CompareRunner(), CompareRunnerProps, DiffVersionSelector(), DiffVersionSelectorProps, Version, CellStatus, TestCase, useCompareRunner() (+19 more)
...
Cohesion: 0.08
Nodes (31): RFC-4122, ApiKeysPage(), dynamic, metadata, dynamic, metadata, ApiKeyRow, ApiKeysManager() (+23 more)
...
Cohesion: 0.06
Nodes (58): DashboardPage(), dynamic, getPromptsWithStats(), metadata, ComparePage(), dynamic, generateMetadata(), DiffPage() (+50 more)

### Community 10 - "actions/webhooks.ts"
Cohesion: 0.14
Nodes (18): RFC-1918, dynamic, metadata, WebhooksPage(), Webhook, WebhooksClient(), WebhooksClientProps, webhooks (+10 more)
...
Cohesion: 0.14
Nodes (24): dynamic, GET(), bodySchema, dynamic, POST(), createPromptBodySchema, dynamic, GET() (+16 more)
...
### Community 43 - "regression-tests/route.ts"
Cohesion: 0.13
Nodes (21): dynamic, maxDuration, POST(), testResults, AIPurpose, AIResponse, callAI(), evaluateOutput() (+13 more)
...
### Community 47 - "dashboard-sidebar.tsx"
Cohesion: 0.20
Nodes (9): Home(), FeedbackModal(), DashboardSidebar(), DashboardSidebarProps, PromptSummary, DashboardHeroReplica(), DashboardHeroScreen(), BadgeVersion() (+1 more)
...
## Knowledge Gaps
- **206 isolated node(s):** `eslintConfig`, `nextConfig`, `AddOptions`, `AuthOptions`, `PullOptions` (+201 more)
...
- **Why does `getAuthUserId()` connect `getAuthUserId` to `test-runner.tsx`, `actions/webhooks.ts`, `db/index.ts`, `tests.ts`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `db` connect `db/index.ts` to `getAuthUserId`, `actions/webhooks.ts`, `regression-tests/route.ts`, `tests.ts`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `prompts` connect `getAuthUserId` to `regression-tests/route.ts`, `db/index.ts`, `tests.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `eslintConfig`, `nextConfig`, `AddOptions` to the rest of the system?**
  _206 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `DeveloperFooter.tsx` be split into smaller, more focused modules?**
